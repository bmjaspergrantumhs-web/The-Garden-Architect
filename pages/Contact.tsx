...
import { useStudioNotification } from '../App';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-start">
          ...
          <div>
            ...
            <h1 className="text-6xl font-bold text-stone-950 mb-10 brand-font tracking-tight leading-tight">Consult with The Studio</h1>
